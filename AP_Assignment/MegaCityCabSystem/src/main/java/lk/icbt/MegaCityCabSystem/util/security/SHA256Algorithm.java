package lk.icbt.MegaCityCabSystem.util.security;
...
public class SHA256Algorithm {
    ...
    public boolean verifyPassword(String input, String storedHash) throws Exception {
        String inputHash = makeHash(input);
